insert into course(id, name,created_date,last_updated_date) values(10001,'Learning JPA',sysdate(),sysdate());
insert into course(id, name,created_date,last_updated_date) values(10002,'spring JPA',sysdate(),sysdate());
insert into course(id, name,created_date,last_updated_date) values(10003,'boot JPA',sysdate(),sysdate());
